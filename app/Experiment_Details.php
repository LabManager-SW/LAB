...
class Experiment_Details extends Model
{
    ...
    protected $fillable=['name', 'location', 'end_recruit_date', 'time_taken', 'payment', 'method_desc', 'poa', 'background', 'health_condition','tester_id','required_applicant', 'applicant'];
