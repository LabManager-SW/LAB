...
@section('content')
    <main id="main-container">
        <div class="container logo_spacing">
            ...
            <!-- 실험정보 -->
            <div class="col-md-6">
                <form id="experiment" method="POST" name="experiment" action="{{ route('admin.experiment.update', $data->id) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="poa" name="poa" class="form-control" value="{{old('poa', $data->poa)}}">
                        @if ($errors->has('poa'))
                            <div class="help-block">
                                {{ $errors->first('poa') }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="background" name="background" class="form-control" value="{{old('background', $data->background)}}">
